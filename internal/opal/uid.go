...
var (
	...
	uidThisSP      = UID{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01} // ThisSP (the open session's SP)
	...
	// Methods.
	uidMethodProperties   = UID{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x01}
	uidMethodStartSession = UID{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x02}
	uidMethodAuthenticate = UID{0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x1c} // Opal Authenticate
